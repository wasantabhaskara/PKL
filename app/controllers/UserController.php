...
class UserController extends SecureController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","password","email","photo","user_role_id");
			...
			//Check if Duplicate Record Already Exit In The Database
			$db->where("user_role_id", $modeldata['user_role_id']);
			if($db->has($tablename)){
				$this->view->page_error[] = $modeldata['user_role_id']." Already exist!";
			} 
			if($this->validated()){
