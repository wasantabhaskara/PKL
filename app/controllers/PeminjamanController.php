...
class PeminjamanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$fields = array("peminjaman.id_peminjaman", 
			"peminjaman.divisi_peminjam", 
			"roles.role_name AS roles_role_name", 
			"peminjaman.barang", 
			"stok_barang.nama_barang AS stok_barang_nama_barang", 
			"peminjaman.jumlah_barang", 
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				peminjaman.divisi_peminjam LIKE ? OR 
				peminjaman.barang LIKE ? OR 
				peminjaman.jumlah_barang LIKE ? OR 
				peminjaman.tanggal_peminjaman LIKE ? OR 
				peminjaman.hingga LIKE ? OR 
				peminjaman.keperluan LIKE ?
			)";
			$search_params = array(
		...
		$db->join("roles", "peminjaman.divisi_peminjam = roles.role_id", "INNER");
		$db->join("stok_barang", "peminjaman.barang = stok_barang.id_stok", "INNER");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("divisi_peminjam","barang","jumlah_barang","tanggal_peminjaman","hingga","keperluan");
			...
			$this->sanitize_array = array(
				'barang' => 'sanitize_string',
				'jumlah_barang' => 'sanitize_string',
				'tanggal_peminjaman' => 'sanitize_string',
				'hingga' => 'sanitize_string',
				'keperluan' => 'sanitize_string',
			);
			$this->filter_vals = true; //set whether to remove empty fields
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			$modeldata['divisi_peminjam'] = USER_ROLE;
			if($this->validated()){
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_peminjaman","divisi_peminjam","barang","jumlah_barang","tanggal_peminjaman","hingga","keperluan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'barang' => 'required',
