                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-divisi_peminjam"> Divisi Peminjam</th>
                                                <th  class="td-barang"> Barang</th>
                                                <th  class="td-jumlah_barang"> Jumlah Barang</th>
                                                <th  class="td-tanggal_peminjaman"> Tanggal Peminjaman</th>
                                                <th  class="td-hingga"> Hingga</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-tanggal_peminjaman">
